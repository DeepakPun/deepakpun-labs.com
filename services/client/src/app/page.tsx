        ...
        <div className="bg-amber-950/20 border-l-4 border-amber-500 rounded-r-xl p-4 shadow-md backdrop-blur-sm flex items-start gap-3">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-slate-300 leading-relaxed font-medium">
              Doomsday should conclude with Doom&apos;s absolute defeat,
              allowing Secret Wars to open pitch-black. This structural shift
              ensures Phase 6 escapes feeling like a simple mirror replica of
